 ...
 * @since AM 5.5.0
 */
public class CertificateReaderPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(CertificateReaderPlugin.currentVersion,
				Collections.singletonList(CertificateReader.class));
	}
	...
	public String getPluginVersion() {
		return CertificateReaderPlugin.currentVersion;
	}
}
